...
_Generated: 2026-07-18T15:16:07.062Z_
...
Workspace `mcp.json` _(folder: SmartHome)_

- **/home/anacrethus/AndroidStudioProjects/SmartHome/.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **/home/anacrethus/.claude.json** — _File exists — no servers defined_
